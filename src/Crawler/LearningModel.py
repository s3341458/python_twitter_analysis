...
from  Parser import MatrixParserForLearning
import pickle
...
class NaiveBayesClassifierBernoulli:
    def __init__(self, matrixFileName = "/Users/chengyu/Documents/python/data/matrixForLearning", dicFileName = "/Users/chengyu/Documents/python/data/dictionary"):
        ...
        self.matrixParser = MatrixParserForLearning()
...
if __name__ == "__main__":
    ...
    print NBB.classifyOneSentence(" Telstra Graduate Program 2015: VIC-Melbourne, As one of Australia's Top 10 listed companies")
